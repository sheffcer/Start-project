...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function showTab(tabId) {
      ...
      console.log("Активная вкладка:", activeTab);  // Логирование активной вкладки
      if (activeTab) {
        ...
        console.log("Обертка активной вкладки:", activeTabWrap);  // Логирование обертки вкладки
        if (activeTabWrap) {
      ...
      console.log("Целевой контент:", targetContent);  // Логирование целевого контента
      if (targetContent) {
